...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        place, position = self.place, 0

        ## get to lower bound
        while position < self.lower_bound:
            place, position = place.entrance, position + 1
            if place.is_hive:
                return None
            
        ## find bees
        while place.bees == [] and position < self.upper_bound:
            place, position = place.entrance, position + 1
            if place.is_hive:
                return None
        
        # print("DEBUG:", random_bee(place.bees).health)
